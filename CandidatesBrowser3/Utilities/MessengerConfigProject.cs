...
{
    public class UpdateListMessageConfigProject
    {
    }


    public class MessengerConfigProject1
    {
        ...
        private static MessengerConfigProject1 _instance;

        /// <summary>
        /// Gets the single instance of the Messenger.
        /// </summary>
        public static MessengerConfigProject1 Default
        {
            get
            {
                if (_instance == null)
                {
                    lock (CreationLock)
                    {
                        if (_instance == null)
                        {
                            _instance = new MessengerConfigProject1();
                        }
                    }
                }
        ...
        /// </summary>
        private MessengerConfigProject1()
        {
        }
