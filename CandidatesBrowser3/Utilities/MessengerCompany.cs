...
{
    public class UpdateListMessageCompany
    {
    }
    ...
    public class MessengerCompany
    {
        ...
        private static MessengerCompany _instance;

        /// <summary>
        /// Gets the single instance of the Messenger.
        /// </summary>
        public static MessengerCompany Default
        {
            get
            {
                if (_instance == null)
                {
                    lock (CreationLock)
                    {
                        if (_instance == null)
                        {
                            _instance = new MessengerCompany();
                        }
                    }
                }
