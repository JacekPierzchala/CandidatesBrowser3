...
{
    public class UpdateListMessageCandidateCollection
    {
    }


    public class MessengerCandidateCollection
    {
        ...
        private static MessengerCandidateCollection _instance;

        /// <summary>
        /// Gets the single instance of the Messenger.
        /// </summary>
        public static MessengerCandidateCollection Default
        {
            get
            {
                if (_instance == null)
                {
                    lock (CreationLock)
                    {
                        if (_instance == null)
                        {
                            _instance = new MessengerCandidateCollection();
                        }
                    }
                }
        ...
        /// </summary>
        private MessengerCandidateCollection()
        {
        }
